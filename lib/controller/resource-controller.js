module.exports = function (models, serializer, responseHandler) {
    ...
    return {
        ...
        checkName: function (req, res, next) {
            ...
            res.send(404, JSON.stringify(responseHandler.getErrorResponse(404, 'Resource ' + req.params.name + ' not found')));
        },
        ...
        findAll: function (req, res) {
            ...
            models[name].find(function (err, data) {
                ...
                res.end(JSON.stringify(responseHandler.getResponse(serials)));
            });
        },
