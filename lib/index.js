var Bedoon = function (config) {
    ...
    return {
        ...
        run: function (portHttp) {
            ...
            app.post(prefix + '/:name', historyMiddleware, resourceController.checkName, resourceController.create);
            app.put(prefix + '/:name/:id', historyMiddleware, resourceController.checkName, resourceController.update);
            app.delete(prefix + '/:name/:id', historyMiddleware, resourceController.checkName, resourceController.remove);
        }
