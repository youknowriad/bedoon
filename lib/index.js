var Bedoon = function (config) {
    ...
    if (userResourceName) {
        var LocalStrategy = require('passport-local').Strategy,
            sercurityControllers = require('./controller/security-controller')(serializer, userResourceName);
    ...
    var resourceController = require('./controller/resource-controller')(models, serializer);
